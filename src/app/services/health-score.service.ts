...
export class HealthScoreService {
  ...
  private getRiskDescription(questionId: string, value: any): string {
    const descriptions: Record<string, string> = {
      ...
      'cardio-6': 'HEALTH.RISK_DESCRIPTIONS.cardio-6',
      'cardio-7': 'HEALTH.RISK_DESCRIPTIONS.cardio-7',
      ...
      'musculo-5': 'HEALTH.RISK_DESCRIPTIONS.musculo-5',
      'musculo-6': 'HEALTH.RISK_DESCRIPTIONS.musculo-6',
      'musculo-7': 'HEALTH.RISK_DESCRIPTIONS.musculo-7',
      'musculo-8': 'HEALTH.RISK_DESCRIPTIONS.musculo-8',
      'musculo-9': 'HEALTH.RISK_DESCRIPTIONS.musculo-9',
      ...
      'lifestyle-4': 'HEALTH.RISK_DESCRIPTIONS.lifestyle-4',
      'lifestyle-5': 'HEALTH.RISK_DESCRIPTIONS.lifestyle-5',
      'lifestyle-6': 'HEALTH.RISK_DESCRIPTIONS.lifestyle-6',
